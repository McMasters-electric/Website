    ...
    <section id="contact" className="py-20 bg-black">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          {/* Request a Quote */}
          <div className="max-w-xl w-full mx-auto mx-4 md:mx-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 mt-6 md:mt-16">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-800 text-white rounded-lg border-[3px] border-gray-400 
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-gray-800 text-white rounded-lg border-[3px] border-gray-400 
                               placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-vertical"
                  />
                </div>
